...
static tetty2_errornum WebSocketHandler_channelActive(ttLibC_Tetty2Context *ctx) {
	// call onopen.
	ttLibC_WebSocket *socket = (ttLibC_WebSocket *)ctx->tetty_info->ptr;
...
static tetty2_errornum WebSocketHandler_channelRead(
...
static tetty2_errornum WebSocketHandler_write(
		ttLibC_Tetty2Context *ctx,
		void *data,
		size_t data_size) {

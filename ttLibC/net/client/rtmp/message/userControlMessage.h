/**
 * @file   userControlMessage.h
 * @brief  rtmp message userControlMessage
 *
...
#ifndef TTLIBC_NET_CLIENT_RTMP_MESSAGE_USERCONTROLMESSAGE_H_
#define TTLIBC_NET_CLIENT_RTMP_MESSAGE_USERCONTROLMESSAGE_H_
 ...
 *   ????
 */
typedef struct ttLibC_Net_Client_Rtmp_Message_UserControlMessage {
	ttLibC_RtmpMessage inherit_super;
	ttLibC_UserControlMessage_Type type;
	uint32_t stream_id;
	uint32_t buffer_length;
	uint32_t time;
} ttLibC_Net_Client_Rtmp_Message_UserControlMessage;

typedef ttLibC_Net_Client_Rtmp_Message_UserControlMessage ttLibC_UserControlMessage;
...
#endif /* TTLIBC_NET_CLIENT_RTMP_MESSAGE_USERCONTROLMESSAGE_H_ */

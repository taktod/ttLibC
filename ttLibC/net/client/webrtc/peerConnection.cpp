...
bool TT_ATTRIBUTE_INNER ttLibC_WebrtcPeerConnection_createOffer(
...
bool TT_ATTRIBUTE_INNER ttLibC_WebrtcPeerConnection_createAnswer(
		ttLibC_WebrtcPeerConnection *conn,
		ttLibC_WebrtcEventFunc func,
		ttLibC_WebrtcConstraint *constraint) {
	if(conn == NULL) {
...
bool TT_ATTRIBUTE_INNER ttLibC_WebrtcPeerConnection_setLocalDescription(
		ttLibC_WebrtcPeerConnection *conn,
		ttLibC_WebrtcSdp *sdp) {
	if(conn == NULL) {
		return false;
...
bool TT_ATTRIBUTE_INNER ttLibC_WebrtcPeerConnection_setRemoteDescription(
		ttLibC_WebrtcPeerConnection *conn,
		ttLibC_WebrtcSdp *sdp) {
	if(conn == NULL) {
		return false;
...
bool TT_ATTRIBUTE_INNER ttLibC_WebrtcPeerConnection_addIceCandidate(
		ttLibC_WebrtcPeerConnection *conn,
...
void TT_ATTRIBUTE_INNER ttLibC_WebrtcPeerConnection_close(ttLibC_WebrtcPeerConnection **conn) {
...
bool TT_ATTRIBUTE_INNER ttLibC_WebrtcPeerConnection_AddStream(
		ttLibC_WebrtcPeerConnection *conn,

...
ttLibC_VorbisEncoder TT_ATTRIBUTE_INNER *ttLibC_VorbisEncoder_makeWithInfo(void *vi) {
	(void)vi;
	return NULL;
}

void TT_ATTRIBUTE_INNER *ttLibC_VorbisEncoder_refNativeEncodeContext(ttLibC_VorbisEncoder *encoder) {
	(void)encoder;
	return NULL;
}
